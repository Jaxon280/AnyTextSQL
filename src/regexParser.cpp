...
static const yytype_uint8 yytranslate[] =
{
       ...
       6,     7,     5,    11,     2,    12,     8,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,    15,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     9,     2,    10,    16,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, vlex::NFA** nfa)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (nfa);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, vlex::NFA** nfa)
{
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, vlex::NFA** nfa)
{
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, nfa); \
} while (0)
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, vlex::NFA** nfa)
{
  YYUSE (yyvaluep);
  YYUSE (nfa);
  if (!yymsg)
...
#line 82 "generator/regex.ypp" /* yacc.c:1646  */
    { (yyval.nfa) = build_submatch_NFA((yyvsp[-1].nfa), (yyvsp[-2].svalue)); }
...
#line 107 "generator/regex.ypp" /* yacc.c:1646  */
    { (yyval.charsets) = add_charsets((yyvsp[-1].charsets), (yyvsp[0].charsets)); }
...
#line 114 "generator/regex.ypp" /* yacc.c:1646  */
    { (yyval.charsets) = build_range_charsets((yyvsp[-2].cvalue), (yyvsp[0].cvalue)); }
