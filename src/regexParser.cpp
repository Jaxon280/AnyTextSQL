...
#define YYSTYPE REGEX_YYSTYPE
/* Substitute the variable and function names.  */
#define yyparse regex_yyparse
#define yylex regex_yylex
#define yyerror regex_yyerror
#define yydebug regex_yydebug
#define yynerrs regex_yynerrs

#define yylval regex_yylval
#define yychar regex_yychar

/* Copy the first part of user declarations.  */
#line 2 "generator/regex.ypp" /* yacc.c:339  */
...
#line 82 "regexParser.cpp" /* yacc.c:339  */
...
#line 10 "generator/regex.ypp" /* yacc.c:355  */

#include "parser/nfa.hpp"

#line 124 "regexParser.cpp" /* yacc.c:355  */
...
union REGEX_YYSTYPE {
#line 30 "generator/regex.ypp" /* yacc.c:355  */
...
#line 18 "generator/regex.ypp" /* yacc.c:355  */
...
void free(void *);      /* INFRINGES ON USER NAME SPACE */
     ...
     (!defined __cplusplus || \
      (defined REGEX_YYSTYPE_IS_TRIVIAL && REGEX_YYSTYPE_IS_TRIVIAL)))
...
static const yytype_uint8 yyrline[] = {
    0,  54, 54, 56, 57, 60,  62,  63,  66,  68,  69,  70,  71,
    72, 75, 77, 79, 81, 82,  83,  84,  85,  86,  87,  88,  89,
    90, 91, 94, 96, 98, 100, 102, 103, 106, 107, 110, 111, 114};
#endif

#if REGEX_YYDEBUG || YYERROR_VERBOSE || 0
...
static const char *const yytname[] = {
    ...
    "'*'",       "'('",     "')'",          "'.'",       "'['",
    "']'",       "'+'",     "'-'",          "'|'",       "'%'",
    "'?'",       "'^'",     "RSUBMATCH_TK", "RALPH_TK",  "RCAPT_TK",
    "RDIGIT_TK", "RINT_TK", "RDOUBLE_TK",   "RTEXT_TK",  "$accept",
    "line",      "regex",   "union",        "simple_re", "concat",
    "basic_re",  "star",    "plus",         "select",    "elementary_re",
    "int",       "double",  "text",         "count",     "charset",
    "setitems",  "setitem", "range",        YY_NULLPTR};
#endif
...
#define YYBACKUP(Token, Value)                                 \
    do                                                         \
        if (yychar == YYEMPTY) {                               \
            ...
            yyerror(nfa, YY_("syntax error: cannot back up")); \
            YYERROR;                                           \
        }                                                      \
    while (0)
...
#define YY_SYMBOL_PRINT(Title, Type, Value, Location)  \
    do {                                               \
        if (yydebug) {                                 \
            ...
            yy_symbol_print(stderr, Type, Value, nfa); \
            YYFPRINTF(stderr, "\n");                   \
        }                                              \
    } while (0)
...
static void yy_symbol_print(FILE *yyoutput, int yytype,
                            YYSTYPE const *const yyvaluep, vlex::NFA **nfa) {
    YYFPRINTF(yyoutput, "%s %s (", yytype < YYNTOKENS ? "token" : "nterm",
              yytname[yytype]);

    yy_symbol_value_print(yyoutput, yytype, yyvaluep, nfa);
    YYFPRINTF(yyoutput, ")");
}
...
#define YY_REDUCE_PRINT(Rule)                                  \
    do {                                                       \
        if (yydebug) yy_reduce_print(yyssp, yyvsp, Rule, nfa); \
    } while (0)
...
#line 107 "generator/regex.ypp" /* yacc.c:1646  */
        {
            (yyval.charsets) =
                addCharsets((yyvsp[-1].charsets), (yyvsp[0].charsets));
        }
...
#line 114 "generator/regex.ypp" /* yacc.c:1646  */
        {
            (yyval.charsets) =
                buildRangeCharsets((yyvsp[-2].cvalue), (yyvsp[0].cvalue));
        }
...
#undef YYSYNTAX_ERROR
    ...
    if (yyerrstatus == 3) {
        ...
        if (yychar <= YYEOF) {
            ...
            yydestruct("Error: discarding", yytoken, &yylval, nfa);
            yychar = YYEMPTY;
        }
    }
...
yyerrlab1:
    ...
    for (;;) {
        ...
        yydestruct("Error: popping", yystos[yystate], yyvsp, nfa);
        YYPOPSTACK(1);
        yystate = *yyssp;
        YY_STACK_PRINT(yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
    yyerror(nfa, YY_("memory exhausted"));
    yyresult = 2;
    /* Fall through.  */
#endif
...
yyreturn:
    if (yychar != YYEMPTY) {
        /* Make sure we have latest lookahead translation.  See comments at
           user semantic actions for why this is necessary.  */
        yytoken = YYTRANSLATE(yychar);
        yydestruct("Cleanup: discarding lookahead", yytoken, &yylval, nfa);
    }
    /* Do not reclaim the symbols of the rule whose action triggered
    ...
    YY_STACK_PRINT(yyss, yyssp);
    while (yyssp != yyss) {
        yydestruct("Cleanup: popping", yystos[*yyssp], yyvsp, nfa);
        YYPOPSTACK(1);
    }
#ifndef yyoverflow
...
nfa->transVec[ti].start, nfa->transVec[ti].end); } else { printf("Transition[%d]
start: %d, end: %d, char: %c\n", ti, nfa->transVec[ti].start,
nfa->transVec[ti].end, (char)nfa->transVec[ti].c);
        }
    }
} */
